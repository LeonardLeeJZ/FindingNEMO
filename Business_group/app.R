...
ui <- fluidPage(
  titlePanel(title = "Similar Groups"),
  sidebarLayout(
    sidebarPanel = sidebarPanel(
      ...
      selectInput(inputId = "measure",
              ...
              choices = c("Degree Centrality", "Transitivity", "Assortativity"),
...
server <- function(input, output) {
  ...
  output$networkPlot <- renderPlot({
    ...
    V(filtered_graph)$transitivity <- transitivity(filtered_graph, type="localundirected")
    V(filtered_graph)$assortativity <- assortativity_degree(filtered_graph, directed = FALSE)
