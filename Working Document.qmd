...
anom_nodes <- core %>%
  mutate(revenue_group = case_when(
    ...
    transboundary = ifelse(is.na(transboundary), "no", transboundary),
    group = if_else(group %in% c("Ultimate Benificial Owner", "Company Contact", "Shareholder", "Multi-role Entity"), group, "Company")
  )
